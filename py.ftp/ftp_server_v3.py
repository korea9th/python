...
#    def __init__(self,(conn,addr)):
    ...
    def run(self):
        ...
        while True:
            ...
            if not cmd: break
                ...
                print ('Recieved:',cmd)
                try:
                    func=getattr(self,cmd[:4].decode().strip().upper())
                    func(cmd)
    ...
    def PASV(self,cmd): # from http://goo.gl/3if2U
        ...
        self.conn.send(b'227 Entering Passive Mode (%s,%u,%u).\r\n' % (newip.encode(), port>>8&0xFF, port&0xFF))
    ...
    def STOR(self,cmd):
        fn=os.path.join(self.cwd.encode(),cmd[5:-2])
#        fn=os.path.join(self.cwd,cmd[5:-2])
        print ('Uplaoding:',fn)
